                ...
                <section className={styles.container}>
                    <div className={styles.locationsSection}>
                        ...
                        <div className={styles.locationsList}>
                            {['Nellore', 'Tirupati', 'Hyderabad', 'Chennai', 'Bangalore', 'Vijayawada', 'Visakhapatnam', 'Guntur', 'Ongole', 'Coimbatore', 'Kochi', 'Mysuru', 'Madurai', 'Hubballi', 'Warangal', 'Salem', 'Thiruvananthapuram', 'Thrissur', 'Karimnagar', 'Mangalore', 'Kakinada', 'Rajahmundry', 'Kozhikode'].map((location, index) => (
