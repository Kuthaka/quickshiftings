...
const Navigation = () => {
    ...
    const navLinks: NavLink[] = [
        ...
        { href: '/services', label: 'Services' },
        {
            ...
            label: 'Locations',
            subItems: [
                { href: '/nellore-packers-and-movers', label: 'Nellore' },
                { href: '/tirupati-packers-and-movers', label: 'Tirupati' },
                { href: '/bangalore-packers-and-movers', label: 'Bangalore' },
                { href: '/chennai-packers-and-movers', label: 'Chennai' },
                // { href: '/hyderabad-packers-and-movers', label: 'Hyderabad' },
                // { href: '/vijayawada-packers-and-movers', label: 'Vijayawada' },
                // { href: '/visakhapatnam-packers-and-movers', label: 'Visakhapatnam' },
                // { href: '/coimbatore-packers-and-movers', label: 'Coimbatore' },
                // { href: '/kochi-packers-and-movers', label: 'Kochi' },
                // { href: '/mysuru-packers-and-movers', label: 'Mysuru' },
                // { href: '/madurai-packers-and-movers', label: 'Madurai' },
                // { href: '/hubballi-packers-and-movers', label: 'Hubballi' },
                // { href: '/warangal-packers-and-movers', label: 'Warangal' },
                // { href: '/salem-packers-and-movers', label: 'Salem' },
                // { href: '/thiruvananthapuram-packers-and-movers', label: 'Thiruvananthapuram' },
                // { href: '/thrissur-packers-and-movers', label: 'Thrissur' },
                // { href: '/karimnagar-packers-and-movers', label: 'Karimnagar' },
                // { href: '/mangalore-packers-and-movers', label: 'Mangalore' },
        ...
        <nav className={`${styles.nav} ${isScrolled ? styles.scrolled : ''}`}>
            <div className={styles.container}>
                ...
                <div className={styles.mobileNavIcons}>
                    <a href="tel:+917730912913" className={styles.mobileCallBtn} aria-label="Call Now">
