    ...
    const navLinks: NavLink[] = [
        ...
        { href: '/services', label: 'Services' },
        {
            ...
            subItems: [
                ...
                { href: '/vijayawada', label: 'Vijayawada' },
                { href: '/visakhapatnam', label: 'Visakhapatnam' },
                { href: '/coimbatore', label: 'Coimbatore' },
                { href: '/kochi', label: 'Kochi' },
                { href: '/mysuru', label: 'Mysuru' },
                { href: '/madurai', label: 'Madurai' },
                { href: '/hubballi', label: 'Hubballi' },
                { href: '/warangal', label: 'Warangal' },
                { href: '/salem', label: 'Salem' },
                { href: '/thiruvananthapuram', label: 'Thiruvananthapuram' },
                { href: '/thrissur', label: 'Thrissur' },
                { href: '/karimnagar', label: 'Karimnagar' },
                { href: '/mangalore', label: 'Mangalore' },
                { href: '/guntur', label: 'Guntur' },
                { href: '/kakinada', label: 'Kakinada' },
                { href: '/ongole', label: 'Ongole' },
            ]
        },
